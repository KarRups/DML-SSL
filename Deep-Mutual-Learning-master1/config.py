...
data_arg.add_argument('--num_classes', type=int, default=10,# Was 100, looking to change to Cifar10
...
train_arg.add_argument('--momentum', type=float, default=0.9,
                       help='Momentum value')
train_arg.add_argument('--epochs', type=int, default=20, #default 200, changed
...
misc_arg.add_argument('--use_gpu', type=str2bool, default=True, #changed to default = false
                      help="Whether to run on the GPU")
misc_arg.add_argument('--best', type=str2bool, default=False,
                      help='Load best model or most recent for testing')
misc_arg.add_argument('--random_seed', type=int, default=1,
                      help='Seed to ensure reproducibility')
misc_arg.add_argument('--data_dir', type=str, default='./data/cifar10', # change to Cifar 10s
